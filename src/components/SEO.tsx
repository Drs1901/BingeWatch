...
export const SEO: React.FC<SEOProps> = ({
  ...
  const organizationSchema = {
    ...
    sameAs: [
      'https://facebook.com/bingewatch',
      'https://twitter.com/bingewatch',
      'https://instagram.com/bingewatch',
    ],
    contactPoint: {
      '@type': 'ContactPoint',
      contactType: 'customer support',
      email: 'contact@bingewatch.buzz'
    }
  };
  ...
  return (
    <Helmet>
      ...
      <meta name="twitter:site" content="@bingewatch" />
      <meta name="twitter:creator" content="@bingewatch" />
      ...
      {publishedAt && <meta property="article:author" content="BingeWatch" />}
