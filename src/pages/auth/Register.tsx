...
export const Register = () => {
  ...
  return (
    <>
      <SEO
        title="Sign Up - BingeWatch"
        description="Create your BingeWatch account to start streaming your favorite movies and TV shows."
      />
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-400">
              Join BingeWatch to start watching your favorite content.
            </p>
          </div>
